...
public class ProtobotDriveConstants extends DriveConstants {
    protected static final int k_pigeon2CanId = 17;
    protected static final Length k_modulePerimeterWidth = Length.inches(20.25);
    protected static final Length k_modulePerimeterLength = Length.inches(23.25);
    ...
    private static final double k_coupleRatio = 2.0;

    private static final double k_driveGearRatio = 6.545454545454545;
    private static final double k_steerGearRatio = 10.285714285714286;

    private static final boolean k_steerMotorReversed = true;

    // These are only used for simulation
    private static final double k_steerInertia = 0.00001;
    private static final double k_driveInertia = 0.001;
    // Simulated voltage necessary to overcome friction
    private static final Voltage k_steerFriction = Voltage.volts(0.25);
    private static final Voltage k_driveFriction = Voltage.volts(0.25);
    ...
    protected SwerveModuleConstants createFrontRightConstants() {
        ...
        return m_factory.createModuleConstants(
                ...
                1,
                9,
                new Angle(-0.254639).asRevolutions(),
    ...
    protected SwerveModuleConstants createFrontLeftConstants() {
        ...
        return m_factory.createModuleConstants(
                ...
                3,
                10,
                new Angle(0.477051).asRevolutions(),
                modulePos.getX().asMeters(),
                modulePos.getY().asMeters(),
                false);
    }
    ...
    protected SwerveModuleConstants createBackLeftConstants() {
        ...
        return m_factory.createModuleConstants(
                ...
                5,
                11,
                new Angle(0.185059).asRevolutions(),
                modulePos.getX().asMeters(),
                modulePos.getY().asMeters(),
                false);
    }
    ...
    protected SwerveModuleConstants createBackRightConstants() {
        ...
        return m_factory.createModuleConstants(
                ...
                7,
                12,
                new Angle(0.106934).asRevolutions(),
                modulePos.getX().asMeters(),
                modulePos.getY().asMeters(),
                false);
    }

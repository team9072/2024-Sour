...
public class CtreSwerveDrive implements SwerveDriveI {
    ...
    // Logger
    private final Consumer<Vector2dU<Velocity>> m_logVelocityVector;

    private final Consumer<Current> m_logDriveSupplySumCurrent;
    private final Consumer<List<Double>> m_logDriveSupplyCurrent;

    private final Consumer<Current> m_logDriveStatorSumCurrent;
    private final Consumer<List<Double>> m_logDriveStatorCurrent;
